"""LLM tool schemas for OpenAI-compatible function calling.

This module defines the 9 tool schemas that are sent to the LLM.
...
# All 9 tool schemas in OpenAI-compatible format
...
TOOL_NAMES: list[str] = [schema["function"]["name"] for schema in TOOL_SCHEMAS]
